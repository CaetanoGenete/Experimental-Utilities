...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "release-1.11.0"
  WORKING_DIRECTORY "C:/Users/caeta/Documents/Programming/Projects/C++/Working/Experimental-Utilities/deps/googletest-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/release-1.11.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/caeta/Documents/Programming/Projects/C++/Working/Experimental-Utilities/deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/caeta/Documents/Programming/Projects/C++/Working/Experimental-Utilities/deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
